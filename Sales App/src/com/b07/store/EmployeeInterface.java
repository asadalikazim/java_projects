...
public class EmployeeInterface {
   ...
   * @param quantity the new quantity of the item in inventory.
   ...
   */
  public boolean restockInventory(ItemImpl item, int quantity) throws ItemIdNotFoundException,
      InvalidQuantityException, SQLException, ClassNotFoundException {
  ...
  public int createCustomerAccount(Customer customer) throws UserIdNotFoundException,
      DatabaseInsertException, SQLException, ClassNotFoundException {

    return DatabaseInsertHelper.insertCustomerAccount(customer.getId());
  }
