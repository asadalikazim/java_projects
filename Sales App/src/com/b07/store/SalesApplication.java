...
import com.b07.serialization.Deserialization;
                  ...
                  while (!(adminPageOption.equals("0") || adminPageOption.equals("9"))) {
                    ...
                    try {
                      ...
                      if (adminPageOption.equals("1")) {
                        ...
                        if (DatabaseDriverExtender.clearDatabase()) {
                          System.out.println("Removing the old database successfully");
                          System.out.println("Deserialization complete!");
                          try {
                            Deserialization.insertTheNewDatabase((DatabaseInOneObject) Deserialization.deserialize("theEntireDatabase.ser"));
                            System.out.println("Deserialization complete!");
                          }catch(Exception e){
                            System.out.println("Deserialization not complete, please re-run the program and initialize the database");
                                        ...
                                        if (Integer.valueOf(itemQuantity) > 0) {
                                          ...
                                          if (removal) {
                                            if (cart.containsItem(item)) {
                                              ...
                                              System.out
                                                  .println("Item completely removed from cart");
                                            }
                                          } else {
