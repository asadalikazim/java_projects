...
public class DatabaseSelectHelper extends DatabaseSelector {
   ...
   */
  public static List<Integer> getRoleIds() throws SQLException, ClassNotFoundException {
   ...
   * @throws ClassNotFoundException
   */
  public static String getRoleName(int roleId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws ClassNotFoundException
   */
  public static int getUserRoleId(int userId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static List<User> getUsersDetails() throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static User getUserDetails(int userId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static Admin getAdminDetails(int adminId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static String getPassword(int userId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static List<ItemImpl> getAllItems() throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static ItemImpl getItem(int itemId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static InventoryImpl getInventory() throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query
   */
  public static int getInventoryQuantity(int itemId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static SalesLogImpl getSales() throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static SaleImpl getSaleById(int saleId) throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException if something goes wrong with the query.
   */
  public static List<SaleImpl> getSalesToUser(int userId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   */
  @Deprecated
  public static List<SaleImpl> getItemizedSaleById1(int saleId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
  ...
  /**
   * Use this to get a hashmap of the rows in the itemized sales table with the id saleId.
   * 
   * @param saleId the id of the sale.
   * @return a hashmap of all the items and there respective quantities.
   * @throws SQLException if something goes wrong with the query.
   */
  public static HashMap<ItemImpl, Integer> getItemizedSaleById(int saleId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
    ResultSet results = DatabaseSelector.getItemizedSaleById(saleId, connection);

    HashMap<ItemImpl, Integer> itemizedSale = new HashMap<ItemImpl, Integer>();

    while (results.next()) {
      itemizedSale.put(getItem(results.getInt("ITEMID")), ((Integer) (results.getInt("QUANTITY"))));
    }
   ...
   * @throws SQLException
   */
  public static SalesLogImpl getItemizedSales() throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @return a list of all the accounts for user.
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getUserAccounts(int userId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
    ...
    while (results.next()) {
      ...
      HashMap<ItemImpl, Integer> items = getAccountDetails(accountId);
      for (ItemImpl key : items.keySet()) {
        cart.addItem(key, items.get(key));
      }

      CustomerAccountImpl account = new CustomerAccountImpl(cart, customer, accountId);
   ...
   * 
   * @param userId Id of the user.
   * @return a list of all the accounts for customer with id customerId.
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getCustomerAccounts(int customerId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
    ResultSet results = DatabaseSelector.getUserAccounts(customerId, connection);
  ...
  /**
   * Use this to get a HashMap made from all the values in the account with id accountId
   * 
   * @param accountId the id of the account
   * @return the HashMap of all details of the account.
   * @throws SQLException if something goes wrong with the query.
   */
  public static HashMap<ItemImpl, Integer> getAccountDetails(int accountId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
  ...
  /**
   * Use this to get a list of all the active accounts in the accountId table related to userId.
   * 
   * @param userId Id of the user.
   * @return a list of all the active accounts for customer with id userId.
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getUserActiveAccounts(int userId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getCustomerActiveAccounts(int customerId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
    ResultSet results = DatabaseSelector.getUserActiveAccounts(customerId, connection);
  ...
  /**
   * Use this to get a list of all the inactive accounts in the accountId table related to userId.
   * 
   * @param userId Id of the user.
   * @return a list of all the active accounts for customer with id userId.
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getUserInactiveAccounts(int userId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
   ...
   * @throws SQLException
   */
  public static List<CustomerAccountImpl> getCustomerInactiveAccounts(int customerId)
      throws SQLException, ClassNotFoundException {
    Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
    ResultSet results = DatabaseSelector.getUserInactiveAccounts(customerId, connection);
